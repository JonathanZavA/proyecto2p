...
class PacienteDAO:
    ...
    """
    _INSERT = ("INSERT INTO pacientes (nombre, apellido, cedula, edad, sexo, especialidad, "
               "tipo_urgencia, fecha, hora, totalpagar) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)")

    _SELECT = ("SELECT nombre, apellido, cedula, edad, sexo, especialidad, tipo_urgencia, fecha, hora, totalpagar "
               "FROM pacientes WHERE cedula = ?")

    _UPDATE = ("UPDATE pacientes SET nombre = ?, apellido = ?, edad = ?, sexo = ?, especialidad = ?, "
               "tipo_urgencia = ?, fecha = ?, hora = ?, totalpagar = ? WHERE cedula = ?")

    _DELETE = "DELETE FROM pacientes WHERE cedula = ?"
